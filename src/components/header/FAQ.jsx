...
const FAQ = ({ isDarkTheme }) => {
  const faqs = [
    ...
    {
      question:
        "How can I make the most of my experience on the AlgoBoost website?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Access to all Linktree resources is completely free, providing you with a wealth of tools and materials to support your journey. For those seeking personalized guidance, we offer advanced features like Personal Consultancy and Interview Preparation. Unlock these benefits with a nominal fee of just ₹99 for a 1-hour video consultation with your seniors. Elevate your preparation with tailored advice and insights designed to help you achieve your goals.",
    },
    {
